...
export default function AnnouncementBar() {
  ...
  return (
    <div className="relative z-50 flex items-center bg-black px-4 py-2 text-[#fff]">
      {cfg.link ? (
        cfg.link.startsWith('/') ? (
      ...
      <button
        onClick={dismiss}
        aria-label="Dismiss"
        className="ml-3 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[#fff]/50 transition-colors hover:text-[#fff]"
      >
