    ...
    <PageShell seoTitle="Page not found">
      <div className="flex min-h-[50vh] flex-col items-center justify-center text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link to="/" className="btn rounded-full bg-black px-6 py-3 font-mono text-[11px] uppercase tracking-[0.16em] text-[#fff] hover:bg-flame-500">
            Back to store
          </Link>
          <Link to="/shop" className="btn rounded-full bg-silver-200 px-6 py-3 font-mono text-[11px] uppercase tracking-[0.16em] text-ink hover:bg-black hover:text-[#fff]">
            Browse the lineup
          </Link>
        </div>
      </div>
